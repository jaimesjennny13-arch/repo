...
public class CJugador implements ActionListener{
    ...
    private void consultar(){
        ...
        String nombre = vista.getTxtNombre().getText();
        Jugador jugador = dao.buscarpornombre(nombre);
        
        if (jugador != null) {
            vista.getTxtEdad().setText(jugador.getEdad());
            vista.getTxtSaldo().setText(String.valueOf(jugador.getSaldo()));
            vista.getTxtTelefono().setText(jugador.getTelefono());
